...
public class FeatureServiceImpl implements FeatureService {
    ...
    public FeatureResponse getFeatureByName(String name) {
        FeatureEntity feature = featureRepository.findByName(name.toLowerCase())
    ...
    public FeatureResponse updateFeature(UUID id, FeatureRequest request) {
        ...
        FeatureEntity updated = featureRepository.save(feature);
    ...
    private FeatureResponse mapToResponse(FeatureEntity feature) {
